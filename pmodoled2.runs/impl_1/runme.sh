...
HD_PWD='C:/Users/long-/Git/Pmod/pmodoled2/pmodoled2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bootstrap.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bootstrap.tcl -notrace
