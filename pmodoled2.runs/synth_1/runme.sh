...
HD_PWD='C:/Users/long-/Git/Pmod/pmodoled2/pmodoled2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bootstrap.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bootstrap.tcl
